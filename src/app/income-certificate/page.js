...
export default function IncomeCertificate() {
  ...
  const generatePDF = () => {
    ...
    // Title
    doc.setFontSize(24);
    doc.text("INCOME CERTIFICATE", 297.5, 80, null, null, "center");
    ...
    doc.setFontSize(14);
    doc.text("resident of:", 60, 270);

    doc.text(address, 60, 300, { maxWidth: 480 });

    doc.setFontSize(16);
    doc.text(
      `has an annual income of ₹${income} as per our records.`,
      60,
      340,
      { maxWidth: 480 }
    );
    ...
    doc.save("income-certificate.pdf");
  };

  return (
    <div className="max-w-xl mx-auto bg-white shadow-md p-6 rounded-lg mt-12">
      <h1 className="text-2xl font-semibold mb-6 text-center">Income Certificate</h1>
      ...
      <div className="flex flex-col gap-6">
        ...
        <FormInput label="Annual Income (in INR)" value={income} onChange={(e) => setIncome(e.target.value)} />
